...
import nj.com.myplayer.media.IRenderView;
import nj.com.myplayer.media.IjkVideoView;
...
//            $.id(R.id.app_video_loading).visible();
     ...
     * @param _i
     */
    public void setVisibility(int _i) {
        if (null != videoView) {
            videoView.setVisibility(_i);
        }
    }
     ...
     * @param _percent
     */
    public void setVolume(float _percent) {
